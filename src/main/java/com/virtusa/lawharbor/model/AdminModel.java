...
public class AdminModel {
	...
	public AdminModel(int id, String name, String email, String phoneNo, String password, boolean active, String role) {
		super();
		this.id = id;
		this.name = name;
		this.email = email;
	...
	public String toString() {
		return "AdminModel [id=" + id + ", name=" + name + ", email=" + email + ", phoneNo=" + phoneNo + ", active="
				+ active + ", role=" + role + "]";
	}
