...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					...
					<a class="nav-link " href="/User/getLawyers/${UserEmail }">Lawyer List </a>
					<a class="nav-link " href="/User/Booking/${UserEmail}">Booking List </a> 
					<a class="nav-link active" aria-current="page" href="/CaseRecord/usercaserecord/${UserEmail}">Case Records </a>
	...
	<div class="container mt-5">
		...
		<table class="table">
		<caption>booked case records: </caption>
			...
			<tbody>
				<c:forEach var="record" items="${RecordList }">
					<tr>
						...
						<td><a href="/CaseRecord/deleteUserRecord/${record.caseRecordId}"><i
